...
docker run -d  --gpus all --env-file .env.example --name agentic-rag-new-server --restart=always -p 5010:5010 -v /home/chyfuture/CHyfuture/workspace:/app/workspace  -e RERANK_MODEL_NAME=workspace/jina-reranker-v3 -e EMBEDDING_DEVICE=cuda agentic-rag-new-server:$VERSION

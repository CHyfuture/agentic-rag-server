...
docker run -d  --env-file .env.example --name agentic-rag-new-server -p 5010:5010 -v /home/general/agentic-rag-new-server/workspace:/app/workspace  -e RERANK_MODEL_NAME=workspace/jina-reranker-v3  agentic-rag-new-server:$VERSION
